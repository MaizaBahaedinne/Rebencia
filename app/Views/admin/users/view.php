    ...
    <ul class="nav nav-tabs mb-3" id="userTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="team-tab" data-bs-toggle="tab" data-bs-target="#team" type="button">
                <i class="fas fa-users-cog me-2"></i>Mon Équipe (<?= count($team_members) ?>)
            </button>
        </li>
        <?php endif; ?>
    </ul>
...
$(document).ready(function() {
    ...
    $('#propertiesTable, #clientsTable, #transactionsTable, #appointmentsTable, #commissionsTable, #teamTable').DataTable({
        language: {
