-- Script pour remplir la table zones avec les gouvernorats et villes du Grand Tunis
-- Vider d'abord toutes les données existantes
TRUNCATE TABLE zones;

-- Réinitialiser l'auto-increment
ALTER TABLE zones AUTO_INCREMENT = 1;

-- Insérer les 4 gouvernorats du Grand Tunis
...
-- Villes de Ben Arous (parent_id = 3)
INSERT INTO zones (name, name_ar, name_en, type, parent_id, country) VALUES
...
-- Mettre à jour les popularity scores (villes les plus populaires)
