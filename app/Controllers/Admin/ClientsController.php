...
class ClientsController extends BaseController
{
    ...
    public function create(): string
    {
        ...
        return $this->render('admin/clients/form', [
            ...
            'constructionStateLabels'  => ClientModel::CONSTRUCTION_STATE_LABELS,
            'furnishedLabels'          => ClientModel::FURNISHED_LABELS,
    ...
    private function buildData(): array
    {
        ...
        $data = [
            ...
            'parking_min'        => ($post['parking_min']        ?? '') ?: null,
            'construction_state' => ($post['construction_state'] ?? '') ?: null,
            'furnished'          => ($post['furnished']          ?? '') ?: null,
