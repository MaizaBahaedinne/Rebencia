                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="status" name="status">
                                    <option value="lead" <?= old('status', 'lead') == 'lead' ? 'selected' : '' ?>>Prospect</option>
                                    ...
                                    <?php if (!empty($agents)): ?>
                                        <?php foreach ($agents as $agent): ?>
                                            <option value="<?= $agent['id'] ?>" 
                                                    <?= old('assigned_agent_id', session()->get('user_id')) == $agent['id'] ? 'selected' : '' ?>>
                                ...
                                <select class="form-select" id="agency_id" name="agency_id">
                                    ...
                                    <?php foreach ($agencies as $agency): ?>
                                        <option value="<?= $agency['id'] ?>" 
                                                <?= old('agency_id', session()->get('agency_id')) == $agency['id'] ? 'selected' : '' ?>>
                                            <?= esc($agency['name']) ?>
                                        </option>
                                    <?php endforeach ?>
                                </select>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="mb-1"><strong id="summaryName">-</strong></p>
                            <p class="text-muted small mb-1"><i class="fas fa-envelope"></i> <span id="summaryEmail">-</span></p>
                            <p class="text-muted small mb-0"><i class="fas fa-phone"></i> <span id="summaryPhone">-</span></p>
                        </div>
                        <hr>
                        ...
                        <div class="mb-3">
                            ...
                            <p class="mb-0"><strong>Statut:</strong> <span id="summaryStatus">Prospect</span></p>
                        </div>
                        <hr>
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted small mb-1"><strong>Type:</strong> <span id="summaryPropertyType">-</span></p>
                            <p class="text-muted small mb-1"><strong>Transaction:</strong> <span id="summaryTransType">-</span></p>
                            <p class="text-muted small mb-0"><strong>Budget:</strong> <span id="summaryBudget">-</span></p>
                        </div>
                        <hr>
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-1"><strong>Agent:</strong> <span id="summaryAgent">-</span></p>
                            <p class="text-muted small mb-0"><strong>Agence:</strong> <span id="summaryAgency">-</span></p>
                        </div>
                    </div>
                </div>
            </div>
...
function updateSummary() {
    ...
    document.getElementById('summaryStatus').textContent = statusSelect.selectedOptions[0]?.text || 'Prospect';
